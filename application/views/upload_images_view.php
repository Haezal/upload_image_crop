...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url()?>dist/css/bootstrap-glyphicons.css" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>assets/css/jquery-ui/hot-sneaks/jquery-ui-1.8.18.custom.css" />

    <script type="text/javascript" src="<?php echo base_url()?>assets/js/jquery-1.8.2.min.js"></script>

    <script src="<?php echo base_url()?>assets/js/jquery-ui/jquery-ui-1.8.18.custom.min.js"></script>
    <script src="<?php echo base_url()?>dist/js/bootstrap.js"></script>

    <!-- color box -->
    <link href="<?php echo base_url()?>assets/colorbox/colorbox.css" rel="stylesheet">
	<script type="text/javascript" src="<?php echo base_url()?>assets/colorbox/jquery.colorbox.js"></script>
	<script type="text/javascript" src="<?php echo base_url()?>assets/js/flash.js"></script>
    <!-- end colorbox -->
    ...
    <script type="text/javascript" src="<?php echo base_url()?>assets/js/touch.js"></script>
...
<div class="panel panel-primary">
    <div class="panel-body">
        ...
        <div id="big_uploader">
            <form name="upload_big" id="upload_big" class="uploaderForm" method="post" enctype="multipart/form-data" action="<?php echo site_url('upload_image/upload/upload');?>" target="upload_target">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="uploadThumbWrapper">
                    ...
                    <form name="upload_thumb" id="upload_thumb" class="uploaderForm" method="post" action="<?php echo site_url('upload_image/upload/thumb');?>" target="upload_target">
